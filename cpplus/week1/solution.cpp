...
//    while (true) {
//        // Changed 10 to 4
//        int n = rand() % 1000 + 2; // generates random number between 1 and 9, returning a number between 2 and 11
//        cout << n << "\n";
...
//            a.push_back(rand() % 100000); // Appending radnom numbers between 0 to 99999
//        }
//
//        for (int i=0; i<n; ++i) {
//            cout << a[i] << ' ';
